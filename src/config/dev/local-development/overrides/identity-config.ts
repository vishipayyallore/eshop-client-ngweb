...
export const localAuthority: OpenIdConfiguration = {
...
export const appEshopLocalServicesIdentity: OpenIdConfiguration = {
...
export const appEshopServicesIdentity: OpenIdConfiguration = {
